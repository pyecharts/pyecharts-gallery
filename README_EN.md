...
* The visual data views generated by pyecharts in version 1.6.0 are compared with the official charts, and the functions that can be achieved and those that cannot be achieved are listed
